 ...
 *
 * one-to-zero:
 *  SqlSessionTemplate 是 MyBatis-Spring 的核心,它是线程安全的，可以被多个 DAO 或映射器所共享使用。
 *  SqlSessionTemplate 采用模板设计模式对 sqlSession 进行管理
 *
...
public class SqlSessionTemplate implements SqlSession, DisposableBean {
    ...
    public <T> T getMapper(Class<T> type) {
        /**
         * 进入mybatis 原生方法 {@link Configuration#getMapper(Class, SqlSession)}
         */
